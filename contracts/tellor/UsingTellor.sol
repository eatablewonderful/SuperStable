...
import "./testContracts/TellorMaster.sol";
import "./libraries/TellorLibrary.sol";//imported for testing ease
import "./testContracts/Tellor.sol";//imported for testing ease
import "./OracleIDDescriptions.sol";
import "./interfaces/EIP2362Interface.sol";
